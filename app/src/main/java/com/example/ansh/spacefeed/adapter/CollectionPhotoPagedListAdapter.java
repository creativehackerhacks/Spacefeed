...
public class CollectionPhotoPagedListAdapter extends PagedListAdapter<CollectionPhoto, CollectionPhotoPagedListAdapter.CollectionViewHolder> {
    ...
    @NonNull
    @Override
    public CollectionPhotoPagedListAdapter.CollectionViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int pos) {
    ...
    @Override
    public void onBindViewHolder(@NonNull CollectionPhotoPagedListAdapter.CollectionViewHolder collectionViewHolder, int pos) {
